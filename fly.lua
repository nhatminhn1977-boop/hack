...
local function fly()
    ...
    -- Xóa vòng lặp cũ nếu có trước khi tạo vòng lặp mới
    ...
    if flying then
        ...
        -- Lưu kết nối để có thể tắt chính xác sau này
...
local function ToggleFlyState()
    ...
    if flying then
        ...
        FlyButton.BackgroundColor3 = Color3.fromRGB(20, 180, 20) -- Đổi sang màu Xanh lá cho dễ nhìn khi bật
        ...
        FlyButton.TextColor3 = Color3.fromRGB(180, 180, 180)
        ButtonStroke.Color = Color3.fromRGB(150, 40, 40)
        fly() -- Gọi fly() để dọn dẹp BodyVelocity cũ
...
-- Sửa logic nút thu nhỏ (Minimize) đầy đủ cả 2 chiều
